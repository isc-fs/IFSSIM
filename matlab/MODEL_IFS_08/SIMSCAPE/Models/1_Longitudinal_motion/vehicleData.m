...
vehicle.vehicleMass = 208; %kg
vehicle.cgHeight = 344; % mm
vehicle.tireRollingRadius_cm = 40.64/2; %cm
vehicle.cd                   = 1.2;% Por confirmar con aparicio
vehicle.frontalArea          = 1.33; % m^2
vehicle.frontAxleDis = 1200; % mm
vehicle.rearAxleDis = 1200; % mm
vehicle.tireRollingCoeff     = 0.01;% hoosier R20 16x75 rolling resistance 
