...
vehicle.riderMass = 75; % kg
vehicle.vehicleMass = 209; %kg
vehicle.cgHeight = 344; % mm
vehicle.tireRollingRadius_cm = 40.64/2; %cm
vehicle.cd                   = 1.2;
vehicle.frontalArea          = 1.33; % m^2
vehicle.frontAxleDis = 865.7; % mm
vehicle.rearAxleDis = 704.3; % mm
...
battery.voltage_V = 400;
battery.internal_R_Ohm = 0.002;
battery.cell_capacity  = 3.2; % A*hr
battery.init_soc       = 0.9; % A*hr

%% Reduction Gear
bevGear.gearRatio = 2.91;
bevGear.efficiency = 0.98;

%% Motor Drive
motorDrive.simplePmsmDrv_trqMax_Nm   = 230*1;    %*4 is AWD 
motorDrive.simplePmsmDrv_trqMin_Nm   = -230*1;
motorDrive.simplePmsmDrv_powMax_W    = 80e3*1; %*4 is AWD, 1 one wheel motor
...
motorDrive.simplePmsmDrv_rotorInertia_kg_m2 = 0.02521 ; % 3.93*0.01^2/3
motorDrive.simplePmsmDrv_rotorDamping_Nm_per_radps = 1e-4; % valor tipico para un motor de 12kg aprox
...
%% converter
converter.outputVoltage   = 400; % Volts
...
%  Radiator tubes
cooling.n_tubes = 14;                % Number of tubes
