...
t = sprintf([ ...
 'IFSSIM_CHASSIS — 6-DOF rigid body        OWNER: dynamics\\n\\n' ...
 'Newton-Euler in the body frame, forward Euler at 1/960 s.\\n' ...
 'Parameters from IFSSIM_P (settings.json). Mass %.0f kg.\\n\\n' ...
 'INERTIA IS AN ASSUMPTION: Ixx %.0f, Iyy %.0f, Izz %.0f kg m^2 — typical FS\\n' ...
 'values, not measured for this car. Izz sets yaw response, which is what the\\n' ...
 'controller is tuned against. Measure it and move it into settings.json.\\n\\n' ...
 'accel_proper EXCLUDES gravity (it is what an accelerometer reads) and the\\n' ...
 'Coriolis term -omega x v is present. Both are wrong in the UE plant today.\\n\\n' ...
 'Edit build_chassis.m, not this model — it is regenerated.'], ...
 P.Mass, P.Assumed.Ixx, P.Assumed.Iyy, P.Assumed.Izz);
end
