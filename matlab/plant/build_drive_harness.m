...
add_block('built-in/Note',[name '/Notes'],'Position',[60 400], ...
    'Text', sprintf([ ...
     'IFSSIM_DRIVE — open, press Run, watch.\\n\\n' ...
     'The manoeuvre is in the Driver block. Edit build_drive_harness.m to change\\n' ...
     'it — this model is regenerated.\\n\\n' ...
     'Flat road, gravity only. To drive on real terrain the road bus must come\\n' ...
     'from the platform, which is what the FMU boundary is for.\\n\\n' ...
     'Car: %.0f kg, %.0f Nm at the motor, %.2f m wheelbase, mu %.2f.'], ...
